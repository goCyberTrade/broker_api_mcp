...
/**
 * @Author: zyz
 * @Date: 2025/7/10 14:19
 * @Description:复制 WebMvcSseServerTransportProvider 后修改实现
 **/
@Slf4j
public class WebMvcSseServerTransportProviderLocal implements McpServerTransportProvider {

    private static final Logger logger = LoggerFactory.getLogger(WebMvcSseServerTransportProviderLocal.class);
     ...
     * 各渠道工具列表
     */
    private Map<String, String> channelTools;

    /**
     * Constructs a new WebMvcSseServerTransportProviderLocal instance with the default SSE
     * endpoint.
     ...
     */
    public WebMvcSseServerTransportProviderLocal(ObjectMapper objectMapper, String messageEndpoint) {
        this(objectMapper, messageEndpoint, DEFAULT_SSE_ENDPOINT);
    }

    /**
     * Constructs a new WebMvcSseServerTransportProviderLocal instance.
     * @param objectMapper The ObjectMapper to use for JSON serialization/deserialization
     * of messages.
     * @param messageEndpoint The endpoint URI where clients should send their JSON-RPC
     * messages via HTTP POST. This endpoint will be communicated to clients through the
     ...
     */
    public WebMvcSseServerTransportProviderLocal(ObjectMapper objectMapper, String messageEndpoint, String sseEndpoint) {
     ...
     * @throws IllegalArgumentException if any parameter is null
     */
    public WebMvcSseServerTransportProviderLocal(ObjectMapper objectMapper, String baseUrl, String messageEndpoint,
                                                 String sseEndpoint, Map<String, String> channelTools) {
    ...
    private ServerResponse handleSseConnection(ServerRequest request) {
        ...
        try {
            return ServerResponse.sse(sseBuilder -> {
                ...
                WebMvcMcpSessionTransport sessionTransport = new WebMvcMcpSessionTransport(sessionId, apiKey.get(), channel.get(), sseBuilder);
    ...
    private ServerResponse handleMessage(ServerRequest request) {
        ...
        try {
            ...
            log.info("接受到消息:{}  线程号:{} sessionId:{}", body, Thread.currentThread().getName(), sessionId);
     ...
     */
    public class WebMvcMcpSessionTransport implements McpServerTransport {
         ...
         */
        WebMvcMcpSessionTransport(String sessionId, String apiKey, String channel, SseBuilder sseBuilder) {
        ...
        public Mono<Void> sendMessage(McpSchema.JSONRPCMessage message) {
            ...
            return Mono.fromRunnable(() -> {
                try {
                    ...
                    log.info("发送的响应message sessionId:{} text:{} ", sessionId, jsonText);
                    if (message instanceof McpSchema.JSONRPCResponse && channelTools != null) {
                        McpSchema.JSONRPCResponse response = (McpSchema.JSONRPCResponse) message;
                        if (response.result() instanceof McpSchema.ListToolsResult) {
                            JSONObject jsonObject = JSONObject.parseObject(jsonText);
                            jsonObject.getJSONObject("result").put("tools", JSONArray.parseArray(channelTools.get(channel)));
